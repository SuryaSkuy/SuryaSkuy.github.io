...
const ringTexts = [
  'Galaxy of love From jafar',//untuk deskripsi planet layer 1
  "I love you",//untuk deskripsi planet layer 2
  "♡Happy birthday Nabila Pudya Azzahra♡",//untuk deskripsi planet layer 3
...
function createHintText() {
  ...
  const context = canvas.getContext('2d');
  const fontSize = 50;
  const text = 'Happy birthday Sayang Nabila Pudya Azzahra ';
